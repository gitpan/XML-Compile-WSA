...
See L<documentation in the base class|XML::Compile::SOAP::Extension/"SOAP12">.
 
=over 4

=item $obj-E<gt>B<soap12ClientWrapper>(OPERATION, CALL, ARGS)

See L<XML::Compile::SOAP::Extension/"SOAP12">
...
This module is part of XML-Compile-WSA distribution version 0.92,
